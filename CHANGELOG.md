...
- `naga::valid::ValidationError` now is a struct which dereferences to `Box<ValidationErrorInner>` to avoid `clippy::large_result_err` warning. By @beicause in [#9612](https://github.com/gfx-rs/wgpu/pull/9612)
